        ...
        for (let i = 0; i < userAssignmentList.length; i++) {
            if (userAssignmentList[i].player_position === "GOALKEEPER") {
                ...
                if (midfielder1State.kit === nonSelectedPlayer) {
                    if (userAssignmentList[i].player_club === "UNITED") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: unitedKit })
                    } else if (userAssignmentList[i].player_club === "PSG") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: psgKit })
                    } else if (userAssignmentList[i].player_club === "LIVERPOOL") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: liverpoolKit })
                    } else if (userAssignmentList[i].player_club === "REAL_MADRID") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: real_madridKit })
                    } else if (userAssignmentList[i].player_club === "JUVENTUS") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: juventusKit })
                    } else if (userAssignmentList[i].player_club === "CITY") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: cityKit })
                    } else if (userAssignmentList[i].player_club === "INTER") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: interKit })
                    } else if (userAssignmentList[i].player_club === "WEST_HAM") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: west_hamKit })
                    } else if (userAssignmentList[i].player_club === "MILAN") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: milanKit })
                    } else if (userAssignmentList[i].player_club === "ARSENAL") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: arsenalKit })
                    } else if (userAssignmentList[i].player_club === "BARCELONA") {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: barcelonaKit })
                    } else {
                        setMidfielder1State({ selected: midfielder1State.selected, kit: atleticoKit })
                    }
                } else {
